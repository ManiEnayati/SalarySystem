...
public class RandomEmployeePanel {
    ...
    public RandomEmployeePanel(Employee employee){
        ...
        JLabel passwordLabel = new JLabel("Password: " + employee.getPassword());
        ...
        JLabel statusLabel = new JLabel("Salary Type: " + employee.getSalaryTypes());
        statusLabel.setFont(new Font("Book Antiqua", Font.BOLD, 20));
        statusLabel.setBounds(10, 600, 300, 30);
        panel.add(statusLabel);

        JLabel salaryTypeLabel = new JLabel("Activity Type: " + employee.getCurrentStatus());
        salaryTypeLabel.setFont(new Font("Book Antiqua", Font.BOLD, 20));
        salaryTypeLabel.setBounds(10, 650, 300, 30);
