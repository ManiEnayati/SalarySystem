...
public class RandomEmployee {
    ...
    public RandomEmployee() {
        ...
        ArrayList<Department> departments = ReadDepartmentsFromFile.readDepartmentsFromFile("Department.txt");
        for (Department department : departments) {
            departments1.add(department.getName());
        }

        ArrayList<Organization> organizations = ReadOrganizationsFromFile.readOrganizationsFromFile("Organization.txt");
    ...
    public Employee generateEmployee() {
        ...
        employee.setSalaryTypes(generateSalaryType());
    ...
    public Activity generateActivity() {
        ...
        return activities[random.nextInt(activities.length)]; // انتخاب تصادفی یکی از مقادیر
    }
