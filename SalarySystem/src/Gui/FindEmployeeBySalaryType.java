...
public class FindEmployeeBySalaryType {

    private JFrame frame;
    private JTextField field;

    public FindEmployeeBySalaryType() {

        frame = new JFrame("Search Employee By Salary Type");
        ...
        JLabel titleLabel = new JLabel("Search Employee By Salary Type");
        ...
        JLabel nameLabel = new JLabel("Employee Salary Type:");
        ...
        search.addActionListener(e -> {
            ...
            for (Employee employee : employees.values()) {
                if (employee.getSalaryType().equals(target)) {
