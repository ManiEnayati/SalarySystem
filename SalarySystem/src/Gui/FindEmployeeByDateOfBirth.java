...
public class FindEmployeeByDateOfBirth {

    private JFrame frame;
    private JTextField field;

    public FindEmployeeByDateOfBirth() {

        frame = new JFrame("Search Employee By Date Of Birth");
        ...
        JLabel titleLabel = new JLabel("Search Employee By Date Of Birth");
        ...
        JLabel nameLabel = new JLabel("Employee Date Of Birth:");
        ...
        search.addActionListener(e -> {
            ...
            for (Employee employee : employees.values()) {
                if (employee.getDateOfBirth().equals(target)) {
