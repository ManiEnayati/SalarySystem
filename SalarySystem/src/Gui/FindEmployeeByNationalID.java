...
public class FindEmployeeByNationalID {

    private JFrame frame;
    private JTextField field;

    public FindEmployeeByNationalID() {

        frame = new JFrame("Search Employee By National ID");
        ...
        search.addActionListener(e -> {
            ...
            for (Employee employee : employees.values()) {
                if (employee.getNationalID().equals(target)) {
