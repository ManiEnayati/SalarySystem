...
public class FindEmployeeByFatherName {

    private JFrame frame;
    private JTextField field;

    public FindEmployeeByFatherName() {

        frame = new JFrame("Search Employee By Father Name");
        ...
        JLabel titleLabel = new JLabel("Search Employee By Father Name");
        ...
        JLabel nameLabel = new JLabel("Employee Father Name:");
        ...
        search.addActionListener(e -> {
            ...
            for (Employee employee : employees.values()) {
                if (employee.getFatherName().equals(target)) {
