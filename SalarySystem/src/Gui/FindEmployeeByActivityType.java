...
public class FindEmployeeByActivityType {

    private JFrame frame;
    private JTextField field;

    public FindEmployeeByActivityType() {

        frame = new JFrame("Search Employee By Activity Type");
        ...
        JLabel titleLabel = new JLabel("Search Employee By Activity Type");
        ...
        search.addActionListener(e -> {
            ...
            for (Employee employee : employees.values()) {
                if (employee.getCurrentStatus().equals(Activity.valueOf(target))) {
