...
public class FindEmployeeByManeger {

    private JFrame frame;

    public FindEmployeeByManeger() {

        frame = new JFrame("Search Employee By Is Manager");
        ...
        JLabel titleLabel = new JLabel("Search Employee By Is Manager");
