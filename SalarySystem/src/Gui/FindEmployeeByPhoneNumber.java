...
public class FindEmployeeByPhoneNumber {

    private JFrame frame;
    private JTextField field;

    public FindEmployeeByPhoneNumber() {

        frame = new JFrame("Search Employee By Phone Number");
        ...
        search.addActionListener(e -> {
            ...
            for (Employee employee : employees.values()) {
                if (employee.getPhoneNumber().equals(target)) {
