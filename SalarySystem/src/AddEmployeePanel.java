...
public class AddEmployeePanel {
    ...
    public AddEmployeePanel() {
        ...
        passwordField.setBounds(200, 450, 300, 30);
        ...
        JLabel activityTypeList = new JLabel("Salary Type:");
        ...
        JButton backButton = BackButton.createBackButton("DepartmentPanel", buttonColor, hoverColor);
